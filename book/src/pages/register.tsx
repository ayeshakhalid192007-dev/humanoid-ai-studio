...
import { SocialLoader } from '../components/Auth/SocialLoader';
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <div className="text-center">
              <button
                ...
                className="flex items-center justify-center gap-2 mb-3 w-full py-3 rounded-lg bg-white/10 hover:bg-white/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loadingProvider === 'google' ? (
                  <SocialLoader provider="google" size={20} />
                ) : (
              ...
              <button
                ...
                disabled={loadingProvider !== null || isLoading}
                className="flex items-center justify-center gap-2 w-full py-3 rounded-lg bg-white/10 hover:bg-white/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loadingProvider === 'github' ? (
                  <SocialLoader provider="github" size={20} />
                ) : (
                  <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
